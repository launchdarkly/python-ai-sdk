...
Examples:
    ...
    python main.py google-adk-agents        launch-darkly-documentation-summarizer "What is the LaunchDarkly AI SDK?"
...
EXAMPLES: dict[str, str] = {
    ...
    "google-adk-agents": "examples.google_adk_agents_example",
